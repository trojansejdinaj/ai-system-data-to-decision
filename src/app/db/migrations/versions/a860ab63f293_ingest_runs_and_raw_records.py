...
def downgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "id",
            sa.INTEGER(),
            server_default=sa.text("nextval('data_sources_id_seq'::regclass)"),
            autoincrement=True,
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "raw_data", postgresql.JSON(astext_type=sa.Text()), autoincrement=False, nullable=False
        ),
        sa.Column(
            "processed_data",
        ...
        sa.ForeignKeyConstraint(
            ["source_id"], ["data_sources.id"], name=op.f("ingested_records_source_id_fkey")
        ),
